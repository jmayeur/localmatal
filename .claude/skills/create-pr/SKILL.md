---
name: create-pr
description: Run quality gate, create a branch, commit scoped changes, and open a PR for review. Use when the user wants to commit work and open a pull request.
---
